...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Mathi/Desktop/Skole/ERTS/Assignments/ERTS_Assignment2/Assignment_2_zip/EmbeddedSystem_labs/lab3/lab3.cache/compile_simlib/modelsim"
  fi

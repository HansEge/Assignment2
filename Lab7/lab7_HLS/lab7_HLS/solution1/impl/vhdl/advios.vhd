...
architecture behav of advios is 
    ...
    signal advios_ssdm_threa_load_fu_144_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm : STD_LOGIC_VECTOR (1 downto 0);
    attribute fsm_encoding : string;
    attribute fsm_encoding of ap_CS_fsm : signal is "none";
    signal ap_CS_fsm_state1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state1 : signal is "none";
    signal grp_advios_clkDivide_fu_100_oneSecPulse : STD_LOGIC;
    signal grp_advios_clkDivide_fu_100_oneSecPulse_ap_vld : STD_LOGIC;
    signal grp_advios_clkDivide_fu_100_advios_clkCount_o : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_advios_clkDivide_fu_100_advios_clkCount_o_ap_vld : STD_LOGIC;
    signal grp_advios_adviosThread_fu_122_outLeds : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_advios_adviosThread_fu_122_outLeds_ap_vld : STD_LOGIC;
    signal grp_advios_adviosThread_fu_122_oneSecPulse : STD_LOGIC;
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal oneSecPulse : STD_LOGIC_VECTOR (0 downto 0);
    signal advios_clkCount : STD_LOGIC_VECTOR (31 downto 0);
    signal advios_ssdm_threa_1_load_fu_148_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    grp_advios_clkDivide_fu_100 : component advios_clkDivide
    port map (
        ap_clk => clk,
        ap_rst => reset,
    ...
    grp_advios_adviosThread_fu_122 : component advios_adviosThread
    port map (
        ap_clk => clk,
        ap_rst => reset,
        ctrl => ctrl,
    ...
    begin
        if (clk'event and clk =  '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_lv1_0 = advios_ssdm_threa_load_fu_144_p1) and (ap_const_lv1_0 = advios_ssdm_threa_1_load_fu_148_p1))) then 
                advios_clkCount <= ap_const_lv32_0;
            elsif ((ap_const_logic_1 = grp_advios_clkDivide_fu_100_advios_clkCount_o_ap_vld)) then 
    ...
    begin
        if (clk'event and clk =  '1') then
            if ((ap_const_logic_1 = grp_advios_clkDivide_fu_100_oneSecPulse_ap_vld)) then 
                oneSecPulse <= (0=>grp_advios_clkDivide_fu_100_oneSecPulse, others=>'-');
            end if; 
        end if;
    end process;
    ...
    begin
        if (clk'event and clk =  '1') then
            if ((ap_const_logic_1 = grp_advios_adviosThread_fu_122_outLeds_ap_vld)) then 
                outLeds <= grp_advios_adviosThread_fu_122_outLeds;
            end if; 
        end if;
    end process;
    ...
    grp_advios_adviosThread_fu_122_oneSecPulse <= oneSecPulse(0);
end behav;

...
advios_clkDivide::advios_clkDivide(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_advios_clkCount_assi_fu_105_p2);
    sensitive << ( advios_clkCount_i );

    SC_METHOD(thread_advios_clkCount_o);
    sensitive << ( tmp_1_reg_118 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( advios_clkCount_assi_fu_105_p2 );
    ...
    sc_trace(mVcdFile, tmp_1_reg_118, "tmp_1_reg_118");
    sc_trace(mVcdFile, ap_CS_fsm, "ap_CS_fsm");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, advios_clkCount_assi_fu_105_p2, "advios_clkCount_assi_fu_105_p2");
...
void advios_clkDivide::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        tmp_1_reg_118 = tmp_1_fu_112_p2.read();
    }
}

void advios_clkDivide::thread_advios_clkCount_assi_fu_105_p2() {
    advios_clkCount_assi_fu_105_p2 = (!advios_clkCount_i.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(advios_clkCount_i.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void advios_clkDivide::thread_advios_clkCount_o() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(tmp_1_reg_118.read(), ap_const_lv1_1))) {
        advios_clkCount_o = ap_const_lv32_0;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        advios_clkCount_o = advios_clkCount_assi_fu_105_p2.read();
    } else {
...
void advios_clkDivide::thread_oneSecPulse() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
        ...
        oneSecPulse =  (sc_logic) (ap_const_lv1_1[0]);
                ...
                esl_seteq<1,1,1>(tmp_1_fu_112_p2.read(), ap_const_lv1_0))) {
...
void advios_clkDivide::thread_tmp_1_fu_112_p2() {
    tmp_1_fu_112_p2 = (!advios_clkCount_assi_fu_105_p2.read().is_01() || !ap_const_lv32_5F5E0FF.is_01())? sc_lv<1>(): (sc_bigint<32>(advios_clkCount_assi_fu_105_p2.read()) > sc_bigint<32>(ap_const_lv32_5F5E0FF));
}

...
define void @"advios::adviosThread"(i1* %clk, i1* %reset, i4* %ctrl, i4* %inSwitch, i4* %outLeds, i1* %oneSecPulse, i8* %advios_switchs_V, i32* %advios_clkCount, i1* %advios_clk1s_state) {
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1824
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_3), !dbg !1825
  store i4 0, i4* %v_V
  br label %1, !dbg !1826

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  %val_V = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %ctrl), !dbg !1827
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !1846), !dbg !1827
  %val_V_1 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %inSwitch), !dbg !1848
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !1846), !dbg !1848
  %tmp = icmp eq i4 %val_V, 0, !dbg !1853
  br i1 %tmp, label %2, label %6, !dbg !1853

; <label>:2                                       ; preds = %1
  %v_V_load_1 = load i4* %v_V, !dbg !1854
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %outLeds, i4 %v_V_load_1), !dbg !1854
  %tmp_2 = icmp eq i4 %val_V_1, -8, !dbg !1870
  br i1 %tmp_2, label %3, label %4, !dbg !1870

; <label>:3                                       ; preds = %2
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %outLeds, i4 0), !dbg !1871
  store i4 0, i4* %v_V
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !1877

; <label>:4                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{i1* %oneSecPulse}, i64 0, metadata !1878), !dbg !1892
  %tmp_1 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %oneSecPulse), !dbg !1893
  call void @llvm.dbg.value(metadata !{i1 %tmp_1}, i64 0, metadata !1895), !dbg !1884
  br i1 %tmp_1, label %5, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !1890

; <label>:5                                       ; preds = %4
  %v_V_load = load i4* %v_V, !dbg !1896
  %cnt_V = add i4 %v_V_load, 1, !dbg !1896
  call void @llvm.dbg.value(metadata !{i4 %cnt_V}, i64 0, metadata !2155), !dbg !1896
  call void @llvm.dbg.value(metadata !{i4 %cnt_V}, i64 0, metadata !1793), !dbg !2157
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %outLeds, i4 %cnt_V), !dbg !2160
  store i4 %cnt_V, i4* %v_V, !dbg !2157
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2163

; <label>:6                                       ; preds = %1
  %v_V_1 = and i4 %val_V_1, %val_V, !dbg !2164
  call void @llvm.dbg.value(metadata !{i4 %v_V_1}, i64 0, metadata !1793), !dbg !2166
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %outLeds, i4 %v_V_1), !dbg !2168
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %6, %5, %4, %3
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2171
  br label %1, !dbg !2173
}
...
define weak void @"advios::advios"(i1* %clk, i1* %reset, i4* %ctrl, i4* %inSwitch, i4* %outLeds, i1* %oneSecPulse, i8* %advios_switchs_V, i32* %advios_clkCount, i1* %advios_clk1s_state) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %advios_clkCount), !map !95
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %advios_clk1s_state), !map !99
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !2174), !dbg !2177
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !2178), !dbg !2177
  call void @llvm.dbg.value(metadata !{i4* %ctrl}, i64 0, metadata !2179), !dbg !2177
  call void @llvm.dbg.value(metadata !{i4* %inSwitch}, i64 0, metadata !2180), !dbg !2177
  call void @llvm.dbg.value(metadata !{i4* %outLeds}, i64 0, metadata !2181), !dbg !2177
  call void @llvm.dbg.value(metadata !{i1* %oneSecPulse}, i64 0, metadata !2182), !dbg !2177
  call void @llvm.dbg.value(metadata !{i8* %advios_switchs_V}, i64 0, metadata !2183), !dbg !2177
  call void @llvm.dbg.value(metadata !{i32* %advios_clkCount}, i64 0, metadata !2184), !dbg !2177
  call void @llvm.dbg.value(metadata !{i1* %advios_clk1s_state}, i64 0, metadata !2185), !dbg !2177
  call void (...)* @_ssdm_op_SpecTopModule([7 x i8]* @p_str, [7 x i8]* @p_str) nounwind, !dbg !2186
  %advios_ssdm_threa = load i1* @advios_ssdm_thread_M_adviosThread, align 1, !dbg !2188
  br i1 %advios_ssdm_threa, label %1, label %2, !dbg !2188

; <label>:1                                       ; preds = %0
  call void @"advios::adviosThread"(i1* %clk, i1* %reset, i4* %ctrl, i4* %inSwitch, i4* %outLeds, i1* %oneSecPulse, i8* %advios_switchs_V, i32* %advios_clkCount, i1* %advios_clk1s_state), !dbg !2189
  br label %UnifiedUnreachableBlock

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([7 x i8]* @p_str, i32 2, [13 x i8]* @p_str16) nounwind, !dbg !2190
  call void (...)* @_ssdm_op_SpecSensitive([13 x i8]* @p_str16, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !2191
  %advios_ssdm_threa_1 = load i1* @advios_ssdm_thread_M_clkDivide, align 1, !dbg !2192
  br i1 %advios_ssdm_threa_1, label %3, label %4, !dbg !2192

; <label>:3                                       ; preds = %2
  call void @"advios::clkDivide"(i1* %clk, i1* %reset, i4* %ctrl, i4* %inSwitch, i4* %outLeds, i1* %oneSecPulse, i8* %advios_switchs_V, i32* %advios_clkCount, i1* %advios_clk1s_state), !dbg !2193
  br label %UnifiedUnreachableBlock

; <label>:4                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecProcessDecl([7 x i8]* @p_str, i32 2, [10 x i8]* @p_str8) nounwind, !dbg !2194
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !2195
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [6 x i8]* @p_str3, i1* %reset, i32 3) nounwind, !dbg !2196
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !2197
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !2198
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %ctrl) nounwind, !dbg !2199
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %inSwitch) nounwind, !dbg !2200
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %outLeds) nounwind, !dbg !2201
  call void (...)* @_ssdm_op_SpecChannel([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [12 x i8]* @p_str12, i32 1, i32 0, i1* %oneSecPulse) nounwind, !dbg !2202
  call void @_ssdm_op_Write.ap_auto.i1P(i1* %advios_clk1s_state, i1 false), !dbg !2203
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %advios_clkCount, i32 0), !dbg !2204
  ret void, !dbg !2205
